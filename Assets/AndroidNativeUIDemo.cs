...
public class AndroidNativeUIDemo : MonoBehaviour {
	...
	public void ShowAlertPopup(string wanings= ""){
		utilsPlugin.ShowAlertPopup("Warning",wanings);
	}
	...
	public void ShowToastMessage(string filePath = ""){
		utilsPlugin.ShowToastMessage(filePath);
	}
